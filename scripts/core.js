...
const FPS = 60; const timestep = 1000 / FPS; let last_time;

function loop() { last_time = performance.now(); update(); collisions(); lateUpdate(); setTimeout(loop, timestep - (performance.now() - last_time)); }
